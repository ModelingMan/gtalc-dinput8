...
static unsigned long g_SetDirMyDocuments = vcversion::AdjustOffset(0x0048E020);
...
__declspec(naked) void CFileMgr::SetDirMyDocuments(void)
{
	__asm jmp g_SetDirMyDocuments;
}
