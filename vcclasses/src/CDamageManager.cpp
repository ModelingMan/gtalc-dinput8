...
static unsigned long g_GetPanelStatus = vcversion::AdjustOffset(0x005A9850);
...
__declspec(naked) unsigned int CDamageManager::GetPanelStatus(int)
{
	__asm jmp g_GetPanelStatus;
}
